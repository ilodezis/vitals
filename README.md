...
<p align="center">
  <strong>Self-hosted health data lake with 35 MCP tools for Claude.ai</strong><br>
...
- 35 MCP-инструментов для Claude.ai (чтение + запись)
...
- [MCP-интеграция с Claude.ai (35 инструментов)](#-mcp-интеграция-с-claudeai)
...
- 35 инструментов: 21 для чтения + 14 для записи данных
...
**35 инструментов** — Claude может полноценно читать и записывать данные во все домены:

#### Чтение (21 инструмент)
...
- 35 MCP tools for Claude.ai (read + write)
...
- [MCP Integration with Claude.ai (35 tools)](#-mcp-integration-with-claudeai)
...
**35 tools** — Claude can fully read and write data across all domains:
