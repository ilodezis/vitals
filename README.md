...
**30 инструментов** — Claude может полноценно читать и записывать данные во все домены:
...
**30 tools** — Claude can fully read and write data across all domains:
