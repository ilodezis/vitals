...
<p align="center">
  <strong>Self-hosted health data lake with 33 MCP tools for Claude.ai</strong><br>
...
- 33 MCP-инструмента для Claude.ai (чтение + запись)
...
- [MCP-интеграция с Claude.ai (33 инструмента)](#-mcp-интеграция-с-claudeai)
...
- 33 инструмента: 17 для чтения + 16 для записи данных
...
**33 инструмента** — Claude может полноценно читать и записывать данные во все домены:

#### Чтение (17 инструментов)
...
- 33 MCP tools for Claude.ai (read + write)
...
- [MCP Integration with Claude.ai (33 tools)](#-mcp-integration-with-claudeai)
...
**33 tools** — Claude can fully read and write data across all domains:
