...
<p align="center">
  <strong>Self-hosted health data lake with 37 MCP tools for Claude.ai</strong><br>
...
- 37 MCP-инструментов для Claude.ai (чтение + запись)
...
- [MCP-интеграция с Claude.ai (37 инструментов)](#-mcp-интеграция-с-claudeai)
...
- 37 инструментов: 22 для чтения + 15 для записи данных
...
**37 инструментов** — Claude может полноценно читать и записывать данные во все домены:

#### Чтение (22 инструмента)
...
- 37 MCP tools for Claude.ai (read + write)
...
- [MCP Integration with Claude.ai (37 tools)](#-mcp-integration-with-claudeai)
...
**37 tools** — Claude can fully read and write data across all domains:
